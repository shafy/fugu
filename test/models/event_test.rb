...
class EventTest < ActiveSupport::TestCase
  ...
  context "property validations" do
    ...
    should_not allow_value("{\"Test\": \"192.128.0.12\"}")
      .for(:properties)
      .with_message("You've used a property value that's prohibited by Fugu (such as emails). Learn more about property constraints in the Fugu docs: https://docs.fugu.lol")
